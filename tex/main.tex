...
\IfPDFManagementActiveTF{
    ...
    \RequirePackage{pdfmanagement}\IfPDFManagementActiveTF{
...
\mathcal{F}\left\lbrace \tilde{T}_{\symrm{n}}\Psi\left(\symbf{R},t\right)\right\rbrace=\mathcal{F}\left\lbrace-\frac{1}{2m}\frac{\partial^2}{\partial \symbf{R}^2}\Psi\left(\symbf{R},t\right)\right\rbrace=\frac{k^2}{2m}\mathcal{F}\left\lbrace\Psi\left(\symbf{R},t\right)\right\rbrace,\qquad\tilde{T}_{\symrm{n}}\Psi\left(\symbf{R},t\right)=\frac{1}{2m}\mathcal{F}^{-1}\left\lbrace k^2\mathcal{F}\left\lbrace\Psi\left(\symbf{R},t\right)\right\rbrace\right\rbrace,
\end{equation}
