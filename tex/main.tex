...
\item
  Identity element of vector addition: $\exists\mathbf{0}\in V$ such that $\mathbf{u}+\mathbf{0}=\mathbf{u}$
\item
  Inverse element of vector addition: $\exists(-\mathbf{u})\in V$ such that $\mathbf{u}+(-\mathbf{u})=\mathbf{0}$
\item
  Compatibility of scalar multiplication with field multiplication: $a(b\mathbf{u})=(ab)\mathbf{u}$
\item
  Identity element of scalar multiplication: $1\mathbf{u}=\mathbf{u}$, where $1$ is the multiplicative identity in $F$
\item
...
\item
  Non-negativity: $\lvert\mathbf{u}\rvert\geq 0$, with equality if and only if $\mathbf{u}=\mathbf{0}$
\item
  Absolute scalability: $\lvert a\mathbf{u}\rvert=\lvert a\rvert\lvert\mathbf{u}\rvert$
\item
  Triangle inequality: $\lvert\mathbf{u}+\mathbf{v}\rvert\leq\lvert\mathbf{u}\rvert+\lvert\mathbf{v}\rvert$
\item
  Positive-definiteness: $\lvert\mathbf{u}\rvert=0$ if and only if $\mathbf{u}=\mathbf{0}$
\end{enumerate}
