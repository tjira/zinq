...
- [x] The JSON parser should tell user what fields are missing.
...
- [x] Entropy calculators do not work for molecular systems, since they do not take into account the fact rotations and translations do not contribute to the entropy.
...
- [x] The function for assigning filenames in QD is apparently unsafe.
- [x] Write the initial width of a gaussian in QD.
