...
def resmet():
    ...
    coords *= A2AU; o, v = slice(0, 0), slice(0, 0); natoms = len(atoms)
    ...
    # print the results
    print("    RHF ENERGY: {:.14f} ({} ITERATIONS  )".format(E_HF + VNN, iter))
    ...
    if args.mp2 or args.mp3:
        ...
        if args.mp2 or args.mp3:
            ...
            print("    MP2 ENERGY: {:.14f}".format(E_HF + E_MP2 + VNN))
        ...
        if args.mp3:
            ...
            print("    MP3 ENERGY: {:.14f}".format(E_HF + E_MP2 + E_MP3 + VNN))
    ...
    if args.ccd or args.ccsd:
        ...
        if args.ccd:
            ...
            print("    CCD ENERGY: {:.14f}".format(E_HF + E_CCD + VNN))
        ...
        if args.ccsd:
            ...
            print("   CCSD ENERGY: {:.14f}".format(E_HF + E_CCSD + VNN))
    ...
    if args.fci:
        ...
        # print the results
        print("    FCI ENERGY: {:.14f} ({} DETERMINANTS)".format(E_HF + E_FCI + VNN, len(dets)))

if __name__ == "__main__": resmet()
