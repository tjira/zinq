...
U_1D = np.loadtxt("data/U_1D_3S.dat", skiprows=1)
...
np.savetxt("data/U_2D_3S.mat", np.column_stack((grid_2D, V00_2D, V01_2D, V02_2D, V10_2D, V11_2D, V12_2D, V20_2D, V21_2D, V22_2D)), fmt="%20.14f", header=f"{grid_2D.shape[0]} 11", comments="")
