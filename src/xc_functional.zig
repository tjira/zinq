//! Interface to libxc for evaluating LDA, GGA, and meta-GGA exchange-correlation functionals.
...
/// Holds input variables (density, gradient, kinetic energy density) for exchange-correlation evaluation.
...
/// Holds output potential and energy arrays generated by exchange-correlation functional evaluation.
...
/// Routes evaluation to the appropriate LDA, GGA, or meta-GGA kernel based on functional family.
...
/// Evaluates GGA exchange-correlation energy and potential components using libxc.
...
/// Evaluates LDA exchange-correlation energy and potential components using libxc.
...
/// Evaluates meta-GGA exchange-correlation energy and potential components using libxc.
